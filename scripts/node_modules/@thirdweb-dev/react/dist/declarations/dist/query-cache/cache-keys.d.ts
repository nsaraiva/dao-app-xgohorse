import { ContractAddress, RequiredParam, WalletAddress } from "../types/types";
...
/**
 @internal
 */
export declare function createCacheKeyWithNetwork(input: QueryKey, chainId: RequiredParam<number>): QueryKey;
/**
 * @internal
 */
export declare function invalidateContractAndBalances(queryClient: QueryClient, contractAddress: RequiredParam<ContractAddress>, chainId: RequiredParam<number>): Promise<unknown>;
/**
 @internal
 */
